...
namespace Server
{
    public partial class OrderManage : Form
    {
        ...
        private void gbx_TaoDoAn_Enter(object sender, EventArgs e)
        {
        ...
        {
            string selectQuery = "SELECT * FROM DatHang";
        ...
        private void btn_XuatHoaDon_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng chọn ít nhất một hàng.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
